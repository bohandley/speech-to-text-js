...
declare class SpeechToTextV1 extends GeneratedSpeechToTextV1 {
    ...
    getRecognizeStatus(params: any, callback: any): void | ReadableStream;
    getRecognitionJob(params: any, callback: any): void | ReadableStream;
    createCustomization(params: any, callback: any): void | ReadableStream;
    getRecognitionJobs(params: any, callback: any): void | ReadableStream;
    deleteRecognitionJob(params: any, callback: any): void | ReadableStream;
    getCustomizations(params: any, callback: any): void | ReadableStream;
    createRecognitionJob(params: any, callback: any): void | ReadableStream;
    addCorpus(params: any, callback: any): void | ReadableStream;
    getCorpus(params: any, callback: any): void | ReadableStream;
    deleteCorpus(params: any, callback: any): void | ReadableStream;
    getCorpora(params: any, callback: any): void | ReadableStream;
    addWords(params: any, callback: any): void | ReadableStream;
    addWord(params: any, callback: any): void | ReadableStream;
    getWords(params: any, callback: any): void | ReadableStream;
    getWord(params: any, callback: any): void | ReadableStream;
    deleteWord(params: any, callback: any): void | ReadableStream;
    trainCustomization(params: any, callback: any): void | ReadableStream;
    resetCustomization(params: any, callback: any): void | ReadableStream;
    createSession(params: any, callback: any): void | ReadableStream;
    /**
