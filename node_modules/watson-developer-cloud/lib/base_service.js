...
var BaseService = /** @class */ (function () {
    ...
    BaseService.prototype.getCredentialsFromEnvironment = function (name) {
        ...
        var _username = process.env[_name + "_USERNAME"];
        var _password = process.env[_name + "_PASSWORD"];
        var _api_key = process.env[_name + "_API_KEY"];
        var _url = process.env[_name + "_URL"];
        return {
            username: _username,
            password: _password,
            api_key: _api_key,
